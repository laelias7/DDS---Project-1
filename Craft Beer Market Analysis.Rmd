...
#####We can do more analysis between styles of beers and revenue income in each state. Which could help us identify the popular beer style and possible correlation between them.
