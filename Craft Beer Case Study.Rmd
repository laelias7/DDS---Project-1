...
```{r head}
################ Does the follwoing commnented code necessary?################
# brew <- brew %>%
...
Economic_Impact_In_Millions<-summary(state$`EconomicImpactM$`)#, digits=1)
Annual_Production_Barrels<-summary(state$BarrelsPerYear)#, digits=0)
